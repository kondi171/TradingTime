    ...
    <>
      <nav className='app__nav'>
        ...
        <div className="app__user-panel">
          <span><i class="fa fa-user"></i> Bogdan Ryjec</span>
          <img src={ PanBogdan } alt="Twój Awatar" />
          <ul>
            <li><NavLink className="app__user-panel--link" to="/app/preferences/account"><i class="fa fa-cogs"></i> Konto</NavLink></li>
            <li><NavLink className="app__user-panel--link" to="/app/preferences/help"><i class="fa fa-question-circle"></i> Pomoc</NavLink></li>
            <li><NavLink className="app__user-panel--link" to="/app/preferences/logout"><i class="fa fa-sign-out"></i> Wyloguj</NavLink></li>
          </ul>
        </div>
      </nav>
    </>
